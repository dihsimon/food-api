package com.food.api.core.openapi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.food.api")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Food API").description("API aberta para clientes e restaurantes")
				.version("1").contact(new Contact("DiegoDev", "https://dihsimon.github.io/portfolio/", "diegosimoncarmona@gmail.com"))
				.build();
	}
